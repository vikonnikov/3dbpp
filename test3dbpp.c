...
#define RANDOMTESTS    1     /* Number of test to run for each type */
...
void randomtype(box *i, int W, int H, int D, int type, FILE *file)
{
  itype w, h, d, t;
